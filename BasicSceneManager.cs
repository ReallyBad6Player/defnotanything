...
public class BasicSceneManager : MonoBehaviour
{
	...
	// Token: 0x06001534 RID: 5428 RVA: 0x000026E9 File Offset: 0x000008E9
	public BasicSceneManager()
	{
	}

	// Token: 0x06001535 RID: 5429 RVA: 0x00073560 File Offset: 0x00071760
	[CompilerGenerated]
	...
	{
		// Token: 0x06001536 RID: 5430 RVA: 0x000735AC File Offset: 0x000717AC
		...
		// Token: 0x06001537 RID: 5431 RVA: 0x0007374C File Offset: 0x0007194C
		[DebuggerHidden]
	...
	private sealed class <>c__DisplayClass2_0
	{
		...
		// Token: 0x06001539 RID: 5433 RVA: 0x0007375C File Offset: 0x0007195C
		...
		{
			// Token: 0x0600153A RID: 5434 RVA: 0x000737A8 File Offset: 0x000719A8
			void IAsyncStateMachine.MoveNext()
			{
				int num2;
				int num = num2;
			...
			// Token: 0x0600153B RID: 5435 RVA: 0x0007392C File Offset: 0x00071B2C
			[DebuggerHidden]
			void IAsyncStateMachine.SetStateMachine(IAsyncStateMachine stateMachine)
			{
				this.<>t__builder.SetStateMachine(stateMachine);
	...
	{
		// Token: 0x0600153C RID: 5436 RVA: 0x0007393C File Offset: 0x00071B3C
		void IAsyncStateMachine.MoveNext()
		{
			int num2;
			int num = num2;
		...
		// Token: 0x0600153D RID: 5437 RVA: 0x00073A14 File Offset: 0x00071C14
		[DebuggerHidden]
		void IAsyncStateMachine.SetStateMachine(IAsyncStateMachine stateMachine)
		{
			this.<>t__builder.SetStateMachine(stateMachine);
	...
	{
		// Token: 0x0600153E RID: 5438 RVA: 0x00073A24 File Offset: 0x00071C24
		void IAsyncStateMachine.MoveNext()
		{
			int num2;
			int num = num2;
		...
		// Token: 0x0600153F RID: 5439 RVA: 0x00073C88 File Offset: 0x00071E88
		[DebuggerHidden]
		void IAsyncStateMachine.SetStateMachine(IAsyncStateMachine stateMachine)
		{
			this.<>t__builder.SetStateMachine(stateMachine);
