...
public class CrittersPawn : CrittersActor, IEyeScannable
{
	...
	public event Action OnDataChange
	{
		...
		add
		{
			Action action = this.OnDataChange;
			Action action2;
			do
			{
				action2 = action;
				Action action3 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.OnDataChange, action3, action2);
			}
	...
	// Token: 0x06000283 RID: 643 RVA: 0x00010104 File Offset: 0x0000E304
	public CrittersPawn()
	{
	}
